   ...
   return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 ml-4 gap-8 p-4">
        <div className="col-span-12 lg:col-span-6 max-w-sm bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
          ...
          <p className="mb-3 font-normal text-gray-900 dark:text-gray-400">Our AI helper will create the most delicious recipes using just the ingredients available to you.</p>
        ...
        <div className="col-span-12 lg:col-span-6 max-w-sm bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
          ...
          <Link href="/OutPage" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">             Read more
            <svg className="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
