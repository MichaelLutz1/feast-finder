...
import { IngredientInventoryAtom, RecipeAtom, ScannedIngredientsAtom } from "./components/atoms"
...
import { RecipeEntry } from "./components/Recipe";
...
export default function Ingredients() {
  ...
  const [recipes,] = useAtom(RecipeAtom)
